...
export default function HomePage() {
  ...
  const handleSearch = async (celebrity1, celebrity2) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8080'}/api/shortest-path?id1=${encodeURIComponent(celebrity1)}&id2=${encodeURIComponent(celebrity2)}&max=5`, { signal: controller.signal });
